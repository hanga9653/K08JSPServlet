...
autoFlush속성을 통해 버퍼가 꽉찬 경우 내보내기 할지를 설정한다.
 -->
<!DOCTYPE html>
<html>
<head>
...
<%
/* 
for문을 통해 10글자(10byte)를 100번 반복해서 출력하므로 1000byte가
된다. 여기에 HTML태그들이 있으므로 해당 페이지의 용량은
...
/* 
	...
	하고 이를 통해 에러페이지처리나 포워드 등의 기능을 수행할수 
	있게 된다. 
*/
%>
</body>
