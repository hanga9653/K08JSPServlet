...
<div class="col-12">
	...
	<nav class="navbar navbar-expand-sm bg-warning navbar-secondary">
		...
		<a class="navbar-brand" href="#"
			onclick="location.href='./boardList.jsp';">> <img
		...
		<ul class="navbar-nav ms-3">
			<li class="nav-item"><a class="nav-link" href="#"
				onclick="location.href='./boardList.jsp';">자유게시판</a></li>
		...
		<ul class="navbar-nav ms-auto">
			...
			<% if(session.getAttribute("UserId")==null){ %>
				<li class="nav-item"><a class="nav-link" href="#"
					onclick="location.href='./LoginForm.jsp';"><i
						class='bi bi-box-arrow-in-right' style='font-size: 20px'></i>로그인</a></li>
			<% } else { %>
				<li class="nav-item"><a class="nav-link" href="#"
					onclick="location.href='./Logout.jsp';">><i
